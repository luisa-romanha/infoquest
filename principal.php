            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav  py-4 py-md-0 d-flex justify-content-end">
                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active">
                  <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="Login.php" role="button" aria-haspopup="true" aria-expanded="false">Entrar na minha conta!</a>
                </li>
                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                  <a class="nav-link" href="#">Categorias</a><i class="fa-solid fa-grip"></i>
                      <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Mais populares</a>
                    <a class="dropdown-item" href="#">História da Computação</a>
...
<section class="card-user">
   ...
   <div class="user-card skeleton">
        ...
        <div class="user-details">
            <div class="user-name hide-text user-not">Usuário não autenticado</div>
            <div class="user-text hide-text">Faça o seu cadastro para ter mais vantagens.<i class="fa-solid fa-id-card"></i></div>

        </div>

        <button class="contact-user hide-text"><a href="cadastro.html">Cadastrar</a></button>
